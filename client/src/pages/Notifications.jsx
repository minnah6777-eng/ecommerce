    ...
    return (
        <div className="max-w-[1640px] mx-auto border-[5px] border-[#f0f0f0] min-h-screen mb-10 overflow-hidden relative">
            ...
            <div className="w-full py-4 md:h-[100px] flex flex-wrap justify-between items-center px-4 md:px-10 gap-4">
                ...
                <div className="w-auto gap-4 md:w-[200px] h-full flex justify-between items-center ">
                    ...
                    <Link to="/notifications">
                        <FaRegBell size={25} className="cursor-pointer text-[#b34141]" />
                    </Link>
            ...
            >
                ...
                <div className="w-full h-10 flex justify-center items-center mt-6 mb-6">
                    {cart.length !== 0 && (
                        <Link to="/checkout" className="w-full flex justify-center">
                            <div className="w-full sm:w-[200px] h-10 bg-[#c72525] flex justify-center items-center rounded-md text-white cursor-pointer font-semibold shadow-md">
                                Checkout
                            </div>
                        </Link>
                    )}
            ...
            {/* Main Content: Notifications Table */}
            <div className="w-full px-4 md:px-10 py-6 min-h-[50vh]">
                <div className="w-full flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-700">Your Orders / Notifications</h2>
                    <Link to="/">
                        <div className="px-6 h-10 bg-[#b34141] flex justify-center items-center cursor-pointer rounded-md hover:bg-[#9c3838] transition-colors shadow-sm">
                            <p className="text-white font-semibold">Continue Shopping</p>
                        </div>
                    </Link>
                </div>
                ...
                {order.length === 0 ? (
                    <div className="w-full flex flex-col items-center justify-center py-20 text-gray-500">
                        <FaRegBell size={60} className="mb-4 text-gray-300" />
                        <p className="text-xl">You have no new notifications or orders.</p>
                    </div>
                ) : (
                    <div className="w-full overflow-x-auto bg-white rounded-lg shadow-sm border border-gray-200">
                        <table className="w-full min-w-[700px]">
                            <thead>
                                <tr className="text-center h-[50px] bg-gray-50 border-b border-gray-200 text-gray-700 font-semibold">
                            ...
                            <tbody>
                                {order.map((data, index) => (
                                    <tr key={index} className="text-center h-[120px] border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                        <td className="px-4 font-medium text-gray-800">{data.title.split(" ")[0]}</td>
                                        <td className="h-full flex justify-center items-center py-2">
                                            <div className="w-20 h-20 bg-[#f4f4f4] rounded-md p-1">
                                                <img
                                                    src={data.image}
                                                    alt={data.title}
                                        ...
                                        <td className="px-4 text-gray-600">RS {data.singleprice}/-</td>
                                        <td className="px-4 text-gray-600">{data.qty}</td>
                                        <td className="px-4 font-semibold text-[#b34141]">RS {data.price}/-</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
